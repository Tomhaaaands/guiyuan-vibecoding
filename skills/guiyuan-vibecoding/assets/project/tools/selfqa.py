#!/usr/bin/env python3
"""Self-contained QA gate for any project scaffolded by Guiyuan Vibecoding (stdlib only).

This tool ships with the published project template so an adopted project can verify its own
manager install and gates without depending on Guiyuan Vibecoding's internal test suite. It is
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Self-QA gate for a Guiyuan Vibecoding project")
