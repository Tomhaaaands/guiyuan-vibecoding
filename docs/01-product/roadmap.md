...
| P9 | settings UI, complete scaffold topology, reference capture, migration audit | next | a user can configure VCM in the admin UI and adopt a legacy layout with a read-only conflict report and confirmed incremental migration |
