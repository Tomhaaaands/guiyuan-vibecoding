...
- The Gitee mirror is published under `tomhands/vibecoding-manager` with anonymous raw files under
  `releases/0.1.0/`; normal-browser verification is still the final external check.
...
## Next
1. Verify the Gitee raw URL from a normal browser in logged-out state and record the confirmed
