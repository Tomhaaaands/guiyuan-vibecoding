...
> on memory-os or any external memory/embedding service. CLI: `tools/distill.py`.

## Why distillation

_bootstrap is a per-project "project manager" kit. For it to self-iterate, each project
...
- The life-manager memory system (memory-os) handles *personal* memory separately; this
