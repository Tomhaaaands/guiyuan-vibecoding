...
This file is the stable product overview and capability index. Detailed requirements and
acceptance live in the capability documents under this directory; tasks must load only the
relevant capability slices.

## Capability index

| Capability | Product authority | Primary technical domains |
| --- | --- | --- |
| install | [install/prd.md](install/prd.md) | packaging, runtime, migration |
| settings | [settings/prd.md](settings/prd.md) | frontend, backend, data, security |
| analysis | [analysis/prd.md](analysis/prd.md) | analysis, providers, artifacts |
| dispatch | [dispatch/prd.md](dispatch/prd.md) | task graph, orchestration |
...
- Normal task-management context remains within the budget in `docs/02-technical/token-budget.md`.
